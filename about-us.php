...
<section class="about__icd__main sectionHeight sectionSpacing">
  <div class="container smallContainer">
    <div class="row">
      <div class="col-md-12">
        <div class="about__main__head">
          <h1>
            <?php if( get_field('about_icd_heading1') ): ?>
            <div class="about__main__line one"><?php echo get_field('about_icd_heading1') ?></div>
            <?php endif; ?>
            <?php if( get_field('about_icd_heading2') ): ?>
            <div class="about__main__line one"><?php echo get_field('about_icd_heading2') ?></div>
            <?php endif; ?>
            <?php if( get_field('about_icd_heading3') ): ?>
            <div class="about__main__line one"><?php echo get_field('about_icd_heading3') ?></div>
            <?php endif; ?>
          </h1>
        </div>
        <div class="about__main__content">
          <?php if( get_field('about_icd_established') ): ?>
          <h2><?php echo get_field('about_icd_established') ?></h2>
          <?php endif; ?>
          <?php if( get_field('about_icd_established1') ): ?>
          <h6><?php echo get_field('about_icd_established1') ?></h6>
          <?php endif; ?>
          <?php if( get_field('about_icd_established2') ): ?>
          <h6><?php echo get_field('about_icd_established2') ?></h6>
          <?php endif; ?>
          <?php if( get_field('about_icd_paragraph') ): ?>
          <p><?php echo get_field('about_icd_paragraph') ?></p>
          <?php endif; ?>
          <img class="about__icd__main__img" src="/wp-content/uploads/2024/11/about-bg.svg">
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      <div class="icd__ceo__wrapper">
        ...
        <div class="icd__ceo__msg">
          ...
          <?php endif; ?>
          <div class="icd_ceo_bio formobiles">
            <?php if( get_field('ceo_name') ): ?>
            <span class="icd__ceo__name"><?php echo get_field('ceo_name') ?></span>
            <?php endif; ?>
            <?php if( get_field('ceo_title') ): ?>
        ...
        <?php
          ...
          if ( $query->have_posts() ) {
            while ( $query->have_posts() ) {
              $query->the_post(); 
              $member_profile = get_field('member_profile');
              $member_designation = get_field('member_designation');
        ?>
          <div class="col-md-3">
            <div class="icd__member">
              <div class="icd__member__img">
                <?php if ($member_profile): ?>
                  <img src="<?php echo esc_url($member_profile); ?>" alt="Board Member">
                <?php endif; ?>
              </div>
              <div class="icd__member__content">
                <p class="icd__member__name"><?php the_title(); ?></p>
                <p class="icd__member__title"><?php echo $member_designation; ?></p>
              </div>
            </div>
          </div>
        <?php } // end while ?>
...
<section class="icd__vision__mission sectionHeight sectionSpacing" id="our-mission-vission-values">
  <div class="container largeContainer">
    <div class="row">
      <div class="col-md-6">
        <div class="icd__vm__box vision">
          <?php if( get_field('vision_heading') ): ?>
          <h6><?php echo get_field('vision_heading') ?></h6>
          <?php endif; ?>
      ...
      <div class="col-md-6">
        <div class="icd__vm__box mission">
          <?php if( get_field('mission_heading') ): ?>
          <h6><?php echo get_field('mission_heading') ?></h6>
          <?php endif; ?>
          <?php if( get_field('mission_description') ): ?>
          <p><?php echo get_field('mission_description') ?></p>
          <?php endif; ?>
        </div>
      </div>
      <div class="col-md-12">
        <div class="icd__vm__box values">
          <div class="values__heading">
            <?php if( get_field('values_heading') ): ?>
            <h6><?php echo get_field('values_heading') ?></h6>
            <?php endif; ?>
            <img class="icd__plus desktop__plus" src="/wp-content/uploads/2024/11/plus.svg">
            <img class="icd__minus desktop__minus" src="/wp-content/uploads/2025/01/minus-icon.svg">
          </div>
          <div class="values__content">
            <?php if( get_field('values_description') ): ?>
            <p><?php echo get_field('values_description') ?></p>
            <?php endif; ?>
          </div>
          <img class="icd__plus mobile__plus" src="/wp-content/uploads/2024/11/plus.svg">
          <img class="icd__minus mobile__minus" src="/wp-content/uploads/2025/01/minus-icon.svg">
          <div class="border__line"></div>
          <div class="values__menu__wrapper">
            <?php if( have_rows('values_listing') ): 
                  while( have_rows('values_listing') ): the_row();
            ?>
            <div class="values__menu__content">
              <h6 class="values__menu"><?php echo get_sub_field('values_listing_headiing') ?></h6>
              <p><?php echo get_sub_field('values_listing_description') ?></p>
            </div>
            <?php endwhile;
            endif; ?>
          </div>
...
<?php if( get_field('select_map_type') == 'info_map' ) { ?>
<div class="map-template-about-us">
<section class="icd__map icd_section sectionHeight sectionSpacing  1" id="global-footprint">
...
<text id="OCEANIA" fill="#D0C89D" xml:space="preserve" style="white-space: pre" font-size="16" font-weight="bold" letter-spacing="-0.02em"><tspan x="1072.69" y="584.318">OCEANIA</tspan></text>
</g>
...
<text id="OCEANIA_2" fill="#D0C89D" xml:space="preserve" style="white-space: pre"   font-size="16" font-weight="bold" letter-spacing="-0.02em"><tspan x="18.6944" y="584.318">OCEANIA</tspan></text>
</g>
</g>
<g id="South America">
<g id="Map_2">
...
<text id="North_2" fill="#D0C89D" xml:space="preserve" style="white-space: pre"   font-size="16" font-weight="bold" letter-spacing="-0.02em"><tspan x="422.152" y="521.318">SOUTH </tspan><tspan x="413.374" y="540.318">AMERICA</tspan></text>
</g>
...
<g id="hover_thing">
<circle id="Main_hover" cx="541.5" cy="525.5" r="25.5" fill=""/>
</g>
</g>
<g id="Tag_2">
<rect id="bg_2" y="497" width="110" height="55" rx="20" fill="white"/>
<text id="South" fill="#D0C89D" xml:space="preserve" style="white-space: pre"   font-size="16" font-weight="bold" letter-spacing="-0.02em"><tspan x="27.1516" y="520.318">SOUTH </tspan><tspan x="18.3741" y="539.318">AMERICA</tspan></text>
</g>
</g>
<g id="North America">
<g id="Map_3">
...
<text id="North_4" fill="#D0C89D" xml:space="preserve" style="white-space: pre"   font-size="16" font-weight="bold" letter-spacing="-0.02em"><tspan x="314.097" y="168.318">NORTH </tspan><tspan x="305.374" y="187.318">AMERICA</tspan></text>
</g>
...
<g id="hover_thing">
<circle id="Main_hover" cx="433.5" cy="172.5" r="25.5" fill=""/>
</g>
</g>
<g id="Tag_3">
<rect id="bg_3" y="145" width="110" height="55" rx="20" fill="white"/>
<text id="North_5" fill="#D0C89D" xml:space="preserve" style="white-space: pre"   font-size="16" font-weight="bold" letter-spacing="-0.02em"><tspan x="27.0969" y="168.318">NORTH </tspan><tspan x="18.3741" y="187.318">AMERICA</tspan></text>
</g>
</g>
<g id="Asia">
<g id="Map_4">
...
<text id="ASIA" fill="#D0C89D" xml:space="preserve" style="white-space: pre"   font-size="16" font-weight="bold" letter-spacing="-0.02em"><tspan x="978.16" y="224.318">ASIA</tspan></text>
</g>
<g id="Live_Pulse_Animation_4">
<circle id="Pulse_4" cx="1068" cy="218" r="10" fill="#ECE8D3" fill-opacity="0.01"/>
<circle id="Main_4" cx="1068.5" cy="218.5" r="7.5" fill="#ECE8D3"/>
</g>
<g id="hover_thing">
<circle id="Main_hover" cx="1069.5" cy="218.5" r="25.5" fill=""/>
</g>
</g>
<g id="Tag_4">
<rect id="bg_4" y="201" width="73" height="35" rx="17.5" fill="white"/>
<text id="ASIA_2" fill="#D0C89D" xml:space="preserve" style="white-space: pre"   font-size="16" font-weight="bold" letter-spacing="-0.02em"><tspan x="17.6597" y="224.318">ASIA</tspan></text>
</g>
</g>
<g id="Africa">
<g id="Map_5">
...
<text id="AFRICA" fill="#D0C89D" xml:space="preserve" style="white-space: pre"   font-size="16" font-weight="bold" letter-spacing="-0.02em"><tspan x="745.753" y="382.318">AFRICA</tspan></text>
</g>
<g id="Live_Pulse_Animation_5">
<circle id="Pulse_5" cx="858" cy="376" r="10" fill="#ECE8D3" fill-opacity="0.01"/>
<circle id="Main_5" cx="858.5" cy="376.5" r="7.5" fill="#ECE8D3"/>
</g>
<g id="hover_thing">
<circle id="Main_hover" cx="858.5" cy="376.5" r="25.5" fill=""/>
</g>
</g>
<g id="Tag_5">
<rect id="bg_5" y="359" width="95" height="35" rx="17.5" fill="white"/>
<text id="AFRICA_2" fill="#D0C89D" xml:space="preserve" style="white-space: pre"   font-size="16" font-weight="bold" letter-spacing="-0.02em"><tspan x="17.7531" y="382.318">AFRICA</tspan></text>
</g>
</g>
<g id="Europe_2">
<g id="Map_6">
...
<text id="EUROPE" fill="#D0C89D" xml:space="preserve" style="white-space: pre"   font-size="16" font-weight="bold" letter-spacing="-0.02em"><tspan x="735.48" y="199.318">EUROPE</tspan></text>
</g>
<g id="Live_Pulse_Animation_6">
<circle id="Pulse_6" cx="852" cy="193" r="10" fill="white" fill-opacity="0.01"/>
<circle id="Main_6" cx="852.5" cy="193.5" r="7.5" fill="white"/>
</g>
<g id="Live_Pulse_Animation_7">
<circle id="Pulse_7" cx="852" cy="193" r="10" fill="#ECE8D3" fill-opacity="0.01"/>
<circle id="Main_7" cx="852.5" cy="193.5" r="7.5" fill="#ECE8D3"/>
</g>
<g id="hover_thing">
<circle id="Main_hover" cx="852.5" cy="193.5" r="25.5" fill=""/>
</g>
</g>
<g id="Tag_6">
<rect id="bg_6" y="176" width="110" height="35" rx="17.5" fill="white"/>
<text id="EUROPE_2" fill="#D0C89D" xml:space="preserve" style="white-space: pre"   font-size="16" font-weight="bold" letter-spacing="-0.02em"><tspan x="23.4797" y="199.318">EUROPE</tspan></text>
</g>
</g>
</g>
</svg>
...
<g id="Tag_1">
<rect id="bg" y="561" width="110" height="35" rx="17.5" fill="white"/>
<text id="Ø£ÙÙÙØ§ÙÙØ³ÙØ§" x="0" y="0" tabindex="0" focusable="true" style="fill: #D0C89D;"><tspan x="80.35" y="584.318">أوقيانوسيا
</tspan></text>
</g>
</g>
<g id="South America">
...
<g id="hover_thing">
<circle id="Main_hover" cx="1073.5" cy="218.5" r="25.5" fill=""/>
</g>
</g>
<g id="Tag_4">
<rect id="bg_4" y="201" width="73" height="35" rx="17.5" fill="white"/>
<text id="Ø¢Ø³ÙØ§" x="0" y="0" tabindex="0" focusable="true" style="fill: #D0C89D;"><tspan x="50.4681" y="224.318">آسيا
</tspan></text>
</g>
</g>
<g id="Africa">
...
<g id="hover_thing">
<circle id="Main_hover" cx="867.5" cy="376.5" r="25.5" fill=""/>
</g>
</g>
<g id="Tag_5">
<rect id="bg_5" y="359" width="95" height="35" rx="17.5" fill="white"/>
<text id="Ø£ÙØ±ÙÙÙØ§" x="0" y="0" tabindex="0" focusable="true" style="fill: #D0C89D;"><tspan x="63.2997" y="382.318">أفريقيا
</tspan></text>
</g>
</g>
<g id="Europe_2">
...
<g id="Tag_6">
<rect id="bg_6" y="176" width="110" height="35" rx="17.5" fill="white"/>
<text id="Ø£ÙØ±ÙØ¨Ø§" x="0" y="0" tabindex="0" focusable="true" style="fill: #D0C89D;"><tspan x="65.3819" y="199.318">أوروبا
</tspan></text>
</g>
</g>
</g>
        ...
        <div class="icd__continents desktop">
...
<div class="icd__countries Continent_<?php echo esc_attr($continent_class); ?>" data-id="Continent_<?php echo esc_attr($continent_class); ?>">
    <h4>
        <b><?php echo esc_html(count(get_sub_field('map_country', 'options'))); ?></b> 
        <?php 
            if ($current_lang == 'en') {
    ...
    <?php 
        $lis = '';
        $count = 0;
        while( have_rows('map_country', 'options') ): the_row(); 
            $country_name = get_sub_field('country_name', 'options'); 
            $lis .= '<li>' . esc_html($country_name) . '</li>';
            $count++;
        endwhile; 
    ?>
    <ul class="icd__countries__list <?php echo $count < 10 ? 'single-column' : ''; ?>">
        <?php if( have_rows('map_country', 'options') ): ?>
    ...
    <?php endif; ?>
      ...
      <?php if( have_rows('map_continents', 'options') ): ?>
        <div class="icd__continents mobile">
          <ul class="icd__continents__tabs overflow-drag">
            <?php while( have_rows('map_continents', 'options') ): the_row(); 
              $continent_name = get_sub_field('continent_name', 'options');
            ?>
              <li data-id="Continent_<?php echo esc_attr($continent_name); ?>" class="continents__tab"><?php echo esc_attr($continent_name); ?></li>
            <?php endwhile; ?>
          </ul>
...
<section class="icd__growth sectionHeight sectionSpacing" id="growth-deversification">
  <div class="container largeContainer">
    <div class="row">
      <div class="col-md-12">
        <div class="icd__growth__wrapper">
          <?php if( get_field('growth_&_diversification_heading') ): ?>
            <h2><?php echo get_field('growth_&_diversification_heading') ?></h2>
          <?php endif; ?>
          <div class="icd__growth__arrows">
              <div class="swiper-button-prev growth__arrow"></div>
              <div class="swiper-button-next growth__arrow"></div>
          </div>
          <div class="icd__growth__main_line">
            <div class="icd__growth__line one"></div>
            <div class="icd__growth__line two"></div>
            <div class="icd__growth__line three"></div>
            <div class="icd__growth__line fourth"></div>
          </div>

          <div class="icd__growth__stats">
            <!-- Swiper for years -->
            <div class="swiper" id="icd__years">
              <div class="swiper-wrapper">
                <?php 
                  if( have_rows('growth_&_diversification_years_list') ): 
                    while( have_rows('growth_&_diversification_years_list') ): the_row();
                      $year = get_sub_field('growth_&_diversification_years');
                      $has_details = have_rows('growth_&_diversification_years_details');
                      $year_class = $has_details ? 'have_post' : 'posts__notfound';
                ?>
                  <div class="swiper-slide <?php echo $year_class; ?>" data-id="year<?php echo $year; ?>">
                    <div class="inner_growth_line">
                      <div class="icd__growth__line one"></div>
                      <div class="icd__growth__line two"></div>
                      <div class="icd__growth__line three"></div>
                      <div class="icd__growth__line fourth"></div>
              ...
              <?php 
                if( have_rows('growth_&_diversification_years_list') ): 
                  while( have_rows('growth_&_diversification_years_list') ): the_row();
                    $year = get_sub_field('growth_&_diversification_years');
              ?>
                <div class="slide_content__wrapper" data-id="year<?php echo $year; ?>" style="display: none;">
                  <?php 
                    if( have_rows('growth_&_diversification_years_details') ): 
                      while( have_rows('growth_&_diversification_years_details') ): the_row();
                        $text_block = get_sub_field('growth_&_diversification_years_text_block');
                  ?>
                    <div class="slide_content__box"><?php echo $text_block; ?></div>
                  <?php 
                      endwhile;
                    endif;
                  ?>
